...
motor_shaft = 13.5;	// NEMA17 motor shaft exact diameter = 5
...
pulley_t_ht = 11.5;	    // length of toothed part of pulley, standard = 12
pulley_b_ht = 11.5;		// pulley base height, standard = 8. Set to same as idler_ht if you want an idler but no pulley.
...
additional_tooth_depth = 1.5; //mm O (zero is default)
